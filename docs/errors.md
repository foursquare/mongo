...
* 10278 [code](http://github.com/mongodb/mongo/blob/master/client/dbclient.cpp#L970) dbclient error communicating with server: 
...
* 14832 [code](http://github.com/mongodb/mongo/blob/master/db/dbcommands.cpp#L911) specify size:<n> when capped is true", !cmdObj["capped"].trueValue() || cmdObj["size"].isNumber() || cmdObj.hasField("$nExtents
...
* 13089 [code](http://github.com/mongodb/mongo/blob/master/db/matcher.cpp#L333) no current client needed for $where
...
* 10149 [code](http://github.com/mongodb/mongo/blob/master/db/ops/update.cpp#L891) Invalid mod field name, may not end in a period
...
* 13496 [code](http://github.com/mongodb/mongo/blob/master/db/ops/update.cpp#L901) invalid mod field name, source may not be empty
...
* 13268 [code](http://github.com/mongodb/mongo/blob/master/db/queryoptimizer.cpp#L953) invalid $or spec
...
* 14817 [code](http://github.com/mongodb/mongo/blob/master/db/queryutil.cpp#L892) $and elements must be objects
...
* 8070 [code](http://github.com/mongodb/mongo/blob/master/s/chunk.cpp#L721) couldn't find a chunk which should be impossible: 
...
s/server.cpp
----
* 10197 [code](http://github.com/mongodb/mongo/blob/master/s/server.cpp#L170) createDirectClient not implemented for sharding yet
* 15849 [code](http://github.com/mongodb/mongo/blob/master/s/server.cpp#L83) client info not defined
...
* 10203 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L445) bad delete message
...
* 13505 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L447) $atomic not supported sharded" , pattern["$atomic
...
* 14805 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L472) collection no longer sharded
* 14806 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L342) collection no longer sharded
...
* 14849 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L433) collection no longer sharded
* 14850 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L371) can't do non-multi update with query that doesn't have a valid shard key
* 14851 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L390) 
* 14854 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L356) can't upsert something without valid shard key
* 14855 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L362) shard key in upsert query must be an exact match
* 14856 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L398) 
* 14857 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L403) 
...
* 8015 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L477) can only delete with a non-shard key pattern if can delete as many as we find
* 8016 [code](http://github.com/mongodb/mongo/blob/master/s/strategy_shard.cpp#L505) can't do this write op on sharded collection
...
util/assert_util.h
----
* 10437 [code](http://github.com/mongodb/mongo/blob/master/util/assert_util.h#L225) unknown boost failed
* 123 [code](http://github.com/mongodb/mongo/blob/master/util/assert_util.h#L74) blah
* 13294 [code](http://github.com/mongodb/mongo/blob/master/util/assert_util.h#L223) 
* 14043 [code](http://github.com/mongodb/mongo/blob/master/util/assert_util.h#L234) 
* 14044 [code](http://github.com/mongodb/mongo/blob/master/util/assert_util.h#L236) unknown boost failed 
...
util/mmap_win.cpp
----
* 13056 [code](http://github.com/mongodb/mongo/blob/master/util/mmap_win.cpp#L256) Async flushing not supported on windows
...
util/net/sock.cpp
----
* 13079 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L152) path to unix socket too long
* 13080 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L150) no unix socket support on windows
* 13082 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L238) 
* 15861 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L463) can't create SSL
* 15864 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L421) can't create SSL Context: 
* 15865 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L429) 
* 15866 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L435) 
* 15867 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L452) Can't read certificate file
* 15868 [code](http://github.com/mongodb/mongo/blob/master/util/net/sock.cpp#L457) Can't read key file
